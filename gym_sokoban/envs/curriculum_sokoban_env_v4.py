...
from .render_utils import room_to_rgb_2
import os
...
class CurriculumSokobanEnv_v4(SokobanEnv):
    def __init__(self, data_path, max_steps=120):
        super(CurriculumSokobanEnv_v4, self).__init__(reset=False)
    ...
    def reset(self):
        ...
        starting_observation = room_to_rgb_2(self.room_state, self.room_fixed)
